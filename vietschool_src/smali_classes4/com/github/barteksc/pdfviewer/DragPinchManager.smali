...
.method private checkLinkTapped(FF)Z
    ...
    check-cast v12, Lcom/shockwave/pdfium/PdfDocument$Link;

    .line 106
    invoke-virtual {v10}, Lcom/shockwave/pdfium/util/SizeF;->getWidth()F
    ...
    .line 107
    invoke-virtual {v10}, Lcom/shockwave/pdfium/util/SizeF;->getHeight()F

    move-result v6

    float-to-int v6, v6

    invoke-virtual {v12}, Lcom/shockwave/pdfium/PdfDocument$Link;->getBounds()Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v3}, Lcom/github/barteksc/pdfviewer/listener/Callbacks;->callLinkHandler(Lcom/github/barteksc/pdfviewer/model/LinkTapEvent;)V
