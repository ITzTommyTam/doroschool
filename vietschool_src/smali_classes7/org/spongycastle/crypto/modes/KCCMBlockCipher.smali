...
.method public processPacket([BII[BI)I
    ...
    .line 260
    iget-boolean v2, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->forEncryption:Z
    ...
    invoke-virtual {v2}, Lorg/spongycastle/crypto/modes/KCCMBlockCipher$ExposedByteArrayOutputStream;->getBuffer()[B
    ...
    invoke-direct {p0, v2, v6, v5, v7}, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->processAAD([BIII)V
    ...
    .line 277
    invoke-direct/range {p0 .. p3}, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->CalculateMac([BII)V

    .line 278
    iget-object v2, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->engine:Lorg/spongycastle/crypto/BlockCipher;

    iget-object v5, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->nonce:[B

    iget-object v7, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->s:[B

    invoke-interface {v2, v5, v6, v7, v6}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 283
    invoke-direct/range {v0 .. v5}, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->ProcessBlock([BII[BI)V
    ...
    invoke-direct {v1, v5}, Lorg/spongycastle/crypto/DataLengthException;-><init>(Ljava/lang/String;)V
    ...
    .line 330
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->s:[B
    ...
    iget-object v8, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->buffer:[B

    invoke-interface {v1, v7, v6, v8, v6}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-interface {v1, v2, v6, v7, v6}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    invoke-direct {p0, p4, v6, v5}, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->CalculateMac([BII)V

    .line 353
    iget-object v1, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->macBlock:[B

    iget-object v2, p0, Lorg/spongycastle/crypto/modes/KCCMBlockCipher;->mac:[B
