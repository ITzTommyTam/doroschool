...
.method public doFinal([BI)I
    ...
    .line 400
    :goto_2
    iget-wide p1, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->atLength:J

    iget v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->atBlockPos:I

    int-to-long v4, v0

    add-long/2addr p1, v4

    iput-wide p1, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->atLength:J

    .line 402
    iget-wide v4, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->atLengthPre:J
    ...
    .line 414
    iget-object p1, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->S_at:[B

    iget-object v7, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->atBlock:[B

    invoke-direct {p0, p1, v7, v1, v0}, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->gHASHPartial([B[BII)V
    ...
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->S_atPre:[B

    invoke-static {p1, v0}, Lorg/spongycastle/crypto/modes/gcm/GCMUtil;->xor([B[B)V
    ...
    .line 428
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/spongycastle/crypto/modes/gcm/GCMExponentiator;
    ...
    iput-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/spongycastle/crypto/modes/gcm/GCMExponentiator;

    .line 431
    iget-object v7, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->H:[B

    invoke-interface {v0, v7}, Lorg/spongycastle/crypto/modes/gcm/GCMExponentiator;->init([B)V

    .line 433
    :cond_6
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->exp:Lorg/spongycastle/crypto/modes/gcm/GCMExponentiator;

    invoke-interface {v0, v2, v3, p1}, Lorg/spongycastle/crypto/modes/gcm/GCMExponentiator;->exponentiateX(J[B)V

    .line 436
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->S_at:[B

    invoke-static {v0, p1}, Lorg/spongycastle/crypto/modes/gcm/GCMUtil;->multiply([B[B)V
    ...
    invoke-static {v2, v3, p1, v0}, Lorg/spongycastle/util/Pack;->longToBigEndian(J[BI)V

    .line 447
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->S:[B

    invoke-direct {p0, v0, p1}, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->gHASHBlock([B[B)V

    .line 450
    new-array p1, p2, [B

    .line 451
    iget-object p2, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->cipher:Lorg/spongycastle/crypto/BlockCipher;

    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->J0:[B

    invoke-interface {p2, v0, v1, p1, v1}, Lorg/spongycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    .line 457
    iget p2, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->macSize:I

    new-array v0, p2, [B

    iput-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->macBlock:[B

    .line 458
    invoke-static {p1, v1, v0, v1, p2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 460
    iget-boolean p1, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->forEncryption:Z

    if-eqz p1, :cond_8

    .line 463
    iget-object p1, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->macBlock:[B

    iget p2, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->bufOff:I

    add-int/2addr p2, v11

    iget v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->macSize:I

    invoke-static {p1, v1, v10, p2, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 470
    iget-object v0, v6, Lorg/spongycastle/crypto/modes/GCMBlockCipher;->bufBlock:[B

    invoke-static {v0, v9, p2, v1, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
