...
.method public calculateMacConstantTime(JS[BIII[B)[B
    ...
    .line 140
    iget-object p3, p2, Lorg/spongycastle/crypto/tls/TlsMac;->context:Lorg/spongycastle/crypto/tls/TlsContext;

    invoke-static {p3}, Lorg/spongycastle/crypto/tls/TlsUtils;->isSSL(Lorg/spongycastle/crypto/tls/TlsContext;)Z
    ...
    invoke-virtual {p0, p3}, Lorg/spongycastle/crypto/tls/TlsMac;->getDigestBlockCount(I)I
    ...
    .line 147
    iget-object p5, p2, Lorg/spongycastle/crypto/tls/TlsMac;->mac:Lorg/spongycastle/crypto/Mac;

    iget p6, p2, Lorg/spongycastle/crypto/tls/TlsMac;->digestBlockSize:I

    invoke-interface {p5, p8, p3, p6}, Lorg/spongycastle/crypto/Mac;->update([BII)V

    goto :goto_1

    .line 151
    :cond_1
    iget-object p4, p2, Lorg/spongycastle/crypto/tls/TlsMac;->mac:Lorg/spongycastle/crypto/Mac;

    aget-byte p3, p8, p3

    invoke-interface {p4, p3}, Lorg/spongycastle/crypto/Mac;->update(B)V

    .line 152
    iget-object p3, p2, Lorg/spongycastle/crypto/tls/TlsMac;->mac:Lorg/spongycastle/crypto/Mac;

    invoke-interface {p3}, Lorg/spongycastle/crypto/Mac;->reset()V
