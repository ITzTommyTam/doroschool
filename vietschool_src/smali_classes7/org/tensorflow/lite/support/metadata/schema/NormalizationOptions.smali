...
.method public static pack(Lcom/google/flatbuffers/FlatBufferBuilder;Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;)I
    .locals 3
    ...
    .line 86
    :cond_0
    invoke-virtual {p1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;->getMean()[F
    ...
    invoke-static {p0, v1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->createMeanVector(Lcom/google/flatbuffers/FlatBufferBuilder;[F)I
    ...
    .line 90
    :goto_0
    invoke-virtual {p1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;->getStd()[F
    ...
    invoke-static {p0, p1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->createStdVector(Lcom/google/flatbuffers/FlatBufferBuilder;[F)I

    move-result v0

    .line 93
    :cond_2
    invoke-static {p0, v1, v0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->createNormalizationOptions(Lcom/google/flatbuffers/FlatBufferBuilder;II)I
...
.method public mean(I)F
    ...
    invoke-virtual {p0, v1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->__vector(I)I
...
.method public unpack()Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;
    .locals 1

    .line 71
    new-instance v0, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;

    invoke-direct {v0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;-><init>()V

    .line 72
    invoke-virtual {p0, v0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->unpackTo(Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;)V

    return-object v0
.end method

.method public unpackTo(Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;)V
    .locals 4

    .line 76
    invoke-virtual {p0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->meanLength()I
    ...
    invoke-virtual {p0, v2}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->mean(I)F
    ...
    .line 78
    :cond_0
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;->setMean([F)V

    .line 79
    invoke-virtual {p0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->stdLength()I
    ...
    invoke-virtual {p0, v1}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptions;->std(I)F
    ...
    .line 81
    :cond_1
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/support/metadata/schema/NormalizationOptionsT;->setStd([F)V
