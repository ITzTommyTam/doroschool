...
.method public get(Lorg/tensorflow/lite/schema/SparsityParameters;I)Lorg/tensorflow/lite/schema/SparsityParameters;
    ...
    iget-object v0, p0, Lorg/tensorflow/lite/schema/SparsityParameters$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {p2, v0}, Lorg/tensorflow/lite/schema/SparsityParameters;->access$000(ILjava/nio/ByteBuffer;)I

    move-result p2

    iget-object v0, p0, Lorg/tensorflow/lite/schema/SparsityParameters$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, p2, v0}, Lorg/tensorflow/lite/schema/SparsityParameters;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/schema/SparsityParameters;
