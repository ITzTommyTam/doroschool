...
.method public static pack(Lcom/google/flatbuffers/FlatBufferBuilder;Lorg/tensorflow/lite/schema/SplitOptionsT;)I
    .locals 0
    ...
    .line 65
    :cond_0
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/SplitOptionsT;->getNumSplits()I

    move-result p1

    .line 63
    invoke-static {p0, p1}, Lorg/tensorflow/lite/schema/SplitOptions;->createSplitOptions(Lcom/google/flatbuffers/FlatBufferBuilder;I)I
...
.method public unpack()Lorg/tensorflow/lite/schema/SplitOptionsT;
    .locals 1

    .line 53
    new-instance v0, Lorg/tensorflow/lite/schema/SplitOptionsT;

    invoke-direct {v0}, Lorg/tensorflow/lite/schema/SplitOptionsT;-><init>()V

    .line 54
    invoke-virtual {p0, v0}, Lorg/tensorflow/lite/schema/SplitOptions;->unpackTo(Lorg/tensorflow/lite/schema/SplitOptionsT;)V

    return-object v0
.end method

.method public unpackTo(Lorg/tensorflow/lite/schema/SplitOptionsT;)V
    .locals 1

    .line 58
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/SplitOptions;->numSplits()I

    move-result v0

    .line 59
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/SplitOptionsT;->setNumSplits(I)V
