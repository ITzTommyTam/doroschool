...
.method public static createBatchMatMulOptions(Lcom/google/flatbuffers/FlatBufferBuilder;ZZZ)I
    .locals 1
    ...
    .line 39
    invoke-static {p0, p3}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->addAsymmetricQuantizeInputs(Lcom/google/flatbuffers/FlatBufferBuilder;Z)V
...
.method public static pack(Lcom/google/flatbuffers/FlatBufferBuilder;Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;)I
    .locals 2
    ...
    .line 77
    :cond_0
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->getAdjX()Z

    move-result v0

    .line 78
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->getAdjY()Z

    move-result v1

    .line 79
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->getAsymmetricQuantizeInputs()Z

    move-result p1

    .line 75
    invoke-static {p0, v0, v1, p1}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->createBatchMatMulOptions(Lcom/google/flatbuffers/FlatBufferBuilder;ZZZ)I
...
.method public unpack()Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;
    .locals 1

    .line 61
    new-instance v0, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;

    invoke-direct {v0}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;-><init>()V

    .line 62
    invoke-virtual {p0, v0}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->unpackTo(Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;)V

    return-object v0
.end method

.method public unpackTo(Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;)V
    .locals 1

    .line 66
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->adjX()Z

    move-result v0

    .line 67
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->setAdjX(Z)V

    .line 68
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->adjY()Z

    move-result v0

    .line 69
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->setAdjY(Z)V

    .line 70
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/BatchMatMulOptions;->asymmetricQuantizeInputs()Z

    move-result v0

    .line 71
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/BatchMatMulOptionsT;->setAsymmetricQuantizeInputs(Z)V
