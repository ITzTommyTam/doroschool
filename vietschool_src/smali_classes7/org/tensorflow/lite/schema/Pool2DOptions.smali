...
.method public static pack(Lcom/google/flatbuffers/FlatBufferBuilder;Lorg/tensorflow/lite/schema/Pool2DOptionsT;)I
    .locals 7
    ...
    .line 95
    :cond_0
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getPadding()B

    move-result v1

    .line 96
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getStrideW()I

    move-result v2

    .line 97
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getStrideH()I

    move-result v3

    .line 98
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getFilterWidth()I

    move-result v4

    .line 99
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getFilterHeight()I

    move-result v5

    .line 100
    invoke-virtual {p1}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->getFusedActivationFunction()B
    ...
    .line 93
    invoke-static/range {v0 .. v6}, Lorg/tensorflow/lite/schema/Pool2DOptions;->createPool2DOptions(Lcom/google/flatbuffers/FlatBufferBuilder;BIIIIB)I
...
.method public unpack()Lorg/tensorflow/lite/schema/Pool2DOptionsT;
    .locals 1

    .line 73
    new-instance v0, Lorg/tensorflow/lite/schema/Pool2DOptionsT;

    invoke-direct {v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;-><init>()V

    .line 74
    invoke-virtual {p0, v0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->unpackTo(Lorg/tensorflow/lite/schema/Pool2DOptionsT;)V

    return-object v0
.end method

.method public unpackTo(Lorg/tensorflow/lite/schema/Pool2DOptionsT;)V
    .locals 1

    .line 78
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->padding()B

    move-result v0

    .line 79
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setPadding(B)V

    .line 80
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->strideW()I

    move-result v0

    .line 81
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setStrideW(I)V

    .line 82
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->strideH()I

    move-result v0

    .line 83
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setStrideH(I)V

    .line 84
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->filterWidth()I

    move-result v0

    .line 85
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setFilterWidth(I)V

    .line 86
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->filterHeight()I

    move-result v0

    .line 87
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setFilterHeight(I)V

    .line 88
    invoke-virtual {p0}, Lorg/tensorflow/lite/schema/Pool2DOptions;->fusedActivationFunction()B

    move-result v0

    .line 89
    invoke-virtual {p1, v0}, Lorg/tensorflow/lite/schema/Pool2DOptionsT;->setFusedActivationFunction(B)V
