...
.method public get(Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options;I)Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options;
    ...
    iget-object v0, p0, Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-static {p2, v0}, Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options;->access$000(ILjava/nio/ByteBuffer;)I

    move-result p2

    iget-object v0, p0, Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options$Vector;->bb:Ljava/nio/ByteBuffer;

    invoke-virtual {p1, p2, v0}, Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options;->__assign(ILjava/nio/ByteBuffer;)Lorg/tensorflow/lite/schema/NonMaxSuppressionV4Options;
