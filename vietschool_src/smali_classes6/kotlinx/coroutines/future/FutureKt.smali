...
.method public static final asCompletableFuture(Lkotlinx/coroutines/Deferred;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 71
    invoke-static {}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m()Ljava/util/concurrent/CompletableFuture;
...
.method private static final asCompletableFuture$lambda$1(Ljava/util/concurrent/CompletableFuture;Lkotlinx/coroutines/Deferred;Ljava/lang/Throwable;)Lkotlin/Unit;
    ...
    invoke-static {p0, p1}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/lang/Object;)Z
    :try_end_0
    ...
    .line 77
    invoke-static {p0, p1}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/lang/Throwable;)Z
...
.method public static final asDeferred(Ljava/util/concurrent/CompletionStage;)Lkotlinx/coroutines/Deferred;
    ...
    .line 113
    invoke-static {p0}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;)Ljava/util/concurrent/CompletableFuture;

    move-result-object v0

    .line 115
    invoke-static {v0}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;)Z
    ...
    .line 118
    :try_start_0
    invoke-static {v0}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;)Ljava/lang/Object;
    ...
    invoke-static {p0, v5}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method private static final asDeferred$lambda$5(Lkotlinx/coroutines/CompletableDeferred;Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    .line 134
    :cond_0
    invoke-static {p2}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p2}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/util/concurrent/CompletionException;
    ...
    invoke-static {p1}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionException;)Ljava/lang/Throwable;
...
.method public static final await(Ljava/util/concurrent/CompletionStage;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 170
    invoke-static {v3}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/util/function/BiFunction;

    move-result-object v4

    invoke-static {p0, v4}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method public static final future(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 39
    invoke-static {v0}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/util/function/BiFunction;

    move-result-object p0

    invoke-static {p1, p0}, Lokhttp3/Headers$Builder$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
